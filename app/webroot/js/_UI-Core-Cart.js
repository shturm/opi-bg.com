...
var CoreCart =
{
 //General Cart
 //XHR urls
 index_url:'http://dev.opi-bg.com/cart/index',
 change_url:"http://dev.opi-bg.com/cart/change",
 add_url:"http://dev.opi-bg.com/cart/add",
 remove_url:"http://dev.opi-bg.com/cart/remove",
 trim_url:"http://dev.opi-bg.com/cart/trim",
 total_price:0,
 step_number:0,
 ...
 */
 ...
 {
  var self = this;
  $("input[name=\"order-cart-button\"]").live("click",function(){window.location = self.index_url;});
 }
 /*End Of [Object]*/
};