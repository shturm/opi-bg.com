<h2>Регистрация на професионалист</h2>
<p>Opi има специално отношение към професионалистите работещи с нашите продукти. Ако сте професионалист в сферата на козметиката - този тип акаунт е за вас.</p>
<?php
	...
	echo $form->input('name', array('label' => 'Лице за контакт<span class="redstar">*</span>'));
