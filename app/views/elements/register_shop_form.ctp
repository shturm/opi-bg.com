...
<?php
	...
	// echo $form->input('egn', array('label' => 'ЕГН')); // this is for professionals only
	echo $form->input('license_code', array('label' => 'Лицензен номер<span class="redstar">*</span>'));
